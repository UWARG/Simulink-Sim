 ...
 * C++ source code generated on : Thu Dec 17 00:18:38 2020
 *
...
void SpikeModelClass::step()
{
  ...
  if (rtmIsMajorTimeStep((&Spike_M))) {
    ...
    rtb_Sum_f_idx_0 = 0.017453292519943295 * Spike_P.FlatEarthtoLLA_psi;

    /* Trigonometry: '<S102>/SinCos' */
    Spike_B.SinCos_o1 = std::sin(rtb_Sum_f_idx_0);
    Spike_B.SinCos_o2 = std::cos(rtb_Sum_f_idx_0);

    /* Sum: '<S120>/Sum' incorporates:
     *  Constant: '<S120>/Constant'
     *  Constant: '<S120>/f'
     */
    rtb_Sum_f_idx_0 = Spike_P.f_Value - Spike_P.Constant_Value_j;
     ...
     *  Sum: '<S121>/Sum1'
     */
    rtb_Sum_f_idx_0 = std::sqrt(Spike_P.Constant_Value_i - rtb_Sum_f_idx_0 *
      rtb_Sum_f_idx_0);
     ...
     */
    rtb_Abs1 = Spike_P.Constant_Value_l - rtb_Sum_f_idx_0 * rtb_Sum_f_idx_0 *
      rtb_Abs1 * rtb_Abs1;
     ...
     *  Sqrt: '<S116>/sqrt'
     */
    rtb_UnitConversion_g = Spike_P.Constant1_Value_k / std::sqrt(rtb_Abs1);
    ...
    Spike_B.TrigonometricFunction1 = rt_atan2d_snf(Spike_P.Constant2_Value_d,
      (Spike_P.Constant_Value_h - rtb_Sum_f_idx_0 * rtb_Sum_f_idx_0) *
      rtb_UnitConversion_g / rtb_Abs1);
    ...
    Spike_B.TrigonometricFunction2 = rt_atan2d_snf(Spike_P.Constant3_Value,
      rtb_UnitConversion_g * std::cos(rtb_Switch));
     ...
     */
    if (rtb_Compare_f) {
      rtb_Sum_d_idx_3 = Spike_P.Constant_Value;
    } else {
      rtb_Sum_d_idx_3 = Spike_P.Constant1_Value;
    }
     ...
     *  Constant: '<S7>/ref_position'
     */
    rtb_Sum_f_idx_0 = rtb_Sum_d_idx_3 + Spike_P.FlatEarthtoLLA_LL0[1];
     ...
     */
    if (std::abs(rtb_Sum_f_idx_0) > Spike_P.CompareToConstant_const_c) {
      Spike_B.Switch_i = rt_modd_snf(rtb_Sum_f_idx_0 + Spike_P.Bias_Bias_f,
        Spike_P.Constant2_Value_g) + Spike_P.Bias1_Bias_b;
    } else {
      Spike_B.Switch_i = rtb_Sum_f_idx_0;
    }
   ...
   */
  rtb_Compare_f = (rtb_Switch > Spike_P.CompareToConstant_const_p);
  ...
  if (rtb_Compare_f) {
    ...
    rtb_Sum_f_idx_0 = ((rtb_Switch + Spike_P.Bias_Bias) * Spike_P.Gain_Gain +
                       Spike_P.Bias1_Bias) * rtb_Sum_d_idx_3;
    rtb_Sum_d_idx_3 = Spike_P.Constant_Value_o;
  } else {
    rtb_Sum_d_idx_3 = Spike_P.Constant1_Value_d;
  }
   ...
   */
  rtb_UnitConversion_g = Spike_P.HNLLat_Value + rtb_Sum_f_idx_0;
   ...
   */
  if (std::abs(rtb_Sum_f_idx_0) > Spike_P.CompareToConstant_const_h) {
    rtb_Sum_f_idx_0 = rt_modd_snf(rtb_Sum_f_idx_0 + Spike_P.Bias_Bias_k,
   ...
   */
  rtb_Sum1_ek = Spike_P.HNLLong_Value + rtb_Sum_f_idx_0;

  /* Gain: '<S6>/1//2rhoV^2' incorporates:
   *  Constant: '<Root>/Constant2'
   *  Product: '<S6>/Product2'
   */
  rtb_Sum_f_idx_0 = rtb_referencearea * Spike_P.Constant2_Value_n *
    Spike_P.u2rhoV2_Gain;

  /* Gain: '<S4>/reference area' */
  rtb_referencearea = Spike_P.AerodynamicForcesandMoments_S * rtb_Sum_f_idx_0;
  Spike_emxInit_char_T(&s, 2);
  if (rtmIsMajorTimeStep((&Spike_M))) {
  ...
  VectorConcatenate[1] = latestData_0 * rtb_Sum1_n_idx_0 - rtb_Sum1_n_idx_2_tmp *
    frac_2[0];
   ...
   *  Trigonometry: '<S26>/sincos'
   */
  rtb_Abs1 = rtb_Sum1_n_idx_2_tmp * frac_tmp_0;
  VectorConcatenate[2] = rtb_Abs1 * rtb_Sum1_n_idx_0 + frac_tmp * frac_2[0];
   ...
   *  Trigonometry: '<S26>/sincos'
   */
  VectorConcatenate[4] = latestData_0 * frac_2[0] + rtb_Sum1_n_idx_2_tmp *
    rtb_Sum1_n_idx_0;

  /* Fcn: '<S26>/Fcn32' incorporates:
   *  Trigonometry: '<S26>/sincos'
   */
  VectorConcatenate[5] = rtb_Abs1 * frac_2[0] - frac_tmp * rtb_Sum1_n_idx_0;
  ...
  rtb_Abs1 = std::sin(rtb_kxj_tmp);
  latestData = std::cos(rtb_jxi);
  rtb_jxi = std::sin(rtb_jxi);

  /* Product: '<S65>/u(3)*u(4)' */
  Spike_B.VectorConcatenate_n[0] = latestData_0 * latestData;
  ...
  Spike_B.VectorConcatenate_n[2] = -rtb_Abs1;
  ...
  /* Product: '<S67>/u(1)*u(4)' */
  Spike_B.VectorConcatenate_n[6] = rtb_Abs1 * latestData;

  /* UnaryMinus: '<S70>/Unary Minus' incorporates:
   *  Product: '<S70>/u(1)*u(2)'
   */
  Spike_B.VectorConcatenate_n[7] = -(rtb_Abs1 * rtb_jxi);

  /* SignalConversion generated from: '<S74>/Vector Concatenate' */
  Spike_B.VectorConcatenate_n[8] = latestData_0;

  /* Gain: '<S3>/reference area' */
  rtb_Sum_f_idx_0 *= Spike_P.AerodynamicForcesandMoments_S_g;
   ...
   *  Gain: '<S3>/coefAdjust'
   */
  rtb_Sum1_n_idx_0 = Spike_P.coefAdjust_Gain_h[0] * rtb_ixk * rtb_Sum_f_idx_0;
  rtb_jxi = Spike_P.coefAdjust_Gain_h[1] * rtb_jxi * rtb_Sum_f_idx_0;
  rtb_kxj = Spike_P.coefAdjust_Gain_h[2] * rtb_kxj * rtb_Sum_f_idx_0;
  ...
  c_fileid = Spike_cfopen_e("SensorOutputs/latitude.txt", "ab");
  ...
  if (!(f == b_NULL)) {
    fprintf(f, "%f\n", Spike_P.Gain3_Gain * (-Spike_X.xeyeze_CSTATE[2] -
             Spike_P.Constant_Value_m));
    if (rtb_Compare_f) {
      fflush(f);
    }
  }
   ...
   *  Sum: '<S4>/Sum'
   */
  rtb_UnitConversion_g = (0.0 - Spike_P.zero1_Value) * frac[0];
   ...
   *  Sum: '<S4>/Sum'
   */
  rtb_Sum1_ek = (0.0 - Spike_P.zero1_Value) * frac[2];
   ...
   */
  rtb_Switch = Spike_P.AerodynamicForcesandMoments_b_h * rtb_Sum_f_idx_0;
  ...
  rtb_jxi = Spike_P.AerodynamicForcesandMoments_c_h * rtb_Sum_f_idx_0 * Gain +
   ...
   *  Sum: '<S42>/Sum'
   */
  rtb_Switch = rtb_Switch * latestData_0 + (frac_tmp_0 - frac_tmp);

  /* Product: '<S45>/Product' incorporates:
   *  Math: '<S45>/Transpose'
   */
  for (iU = 0; iU < 3; iU++) {
    frac[iU] = Spike_B.VectorConcatenate_i[3 * iU + 2] * rtb_Switch +
   ...
   */
  rtb_Switch = Spike_P.AerodynamicForcesandMoments_b * rtb_referencearea;
   ...
   *  Sum: '<S93>/Sum'
   */
  frac_3[0] = (rtb_Switch * rtb_Sum_d_idx_3 + (rtb_fh - rtb_Sum1_ek)) + frac[0];
  frac_3[1] = (Spike_P.AerodynamicForcesandMoments_cba * rtb_referencearea *
               rtb_Sum_d_idx_4 + (rtb_fm - rtb_UnitConversion_g)) +
    Spike_P.Gain2_Gain * frac[1];
  frac_3[2] = (rtb_Switch * rtb_Sum_d_idx_5 + (rtb_UnitConversion_g - rtb_Gain_j))
    + frac[2];
  for (iU = 0; iU < 3; iU++) {
